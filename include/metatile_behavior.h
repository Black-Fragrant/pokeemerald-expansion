...
bool8 MetatileBehavior_IsTallDarkGrass(u8);
bool8 MetatileBehavior_IsLongDarkGrass(u8);
...
bool8 MetatileBehavior_IsLongDarkGrass_Duplicate(u8);
bool8 MetatileBehavior_IsLongDarkGrassSouthEdge(u8);
