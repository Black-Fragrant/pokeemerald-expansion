...
bool8 MetatileBehavior_IsDarkTallGrass(u8);
bool8 MetatileBehavior_IsDarkLongGrass(u8);
...
bool8 MetatileBehavior_IsDarkLongGrass_Duplicate(u8);
bool8 MetatileBehavior_IsDarkLongGrassSouthEdge(u8);
