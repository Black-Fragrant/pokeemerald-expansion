...
#define GROUND_EFFECT_FLAG_TALL_DARK_GRASS_ON_SPAWN (1 << 20)
#define GROUND_EFFECT_FLAG_TALL_DARK_GRASS_ON_MOVE  (1 << 21)
#define GROUND_EFFECT_FLAG_LONG_DARK_GRASS_ON_SPAWN (1 << 22)
#define GROUND_EFFECT_FLAG_LAND_IN_TALL_DARK_GRASS  (1 << 23)
#define GROUND_EFFECT_FLAG_LONG_DARK_GRASS_ON_MOVE  (1 << 24)
#define GROUND_EFFECT_FLAG_LAND_IN_LONG_DARK_GRASS  (1 << 25)
