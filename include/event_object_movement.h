...
#define GROUND_EFFECT_FLAG_TALL_GRASS_ON_SPAWN_DARK       (1 << 20)
#define GROUND_EFFECT_FLAG_TALL_GRASS_ON_MOVE_DARK        (1 << 21)
#define GROUND_EFFECT_FLAG_LAND_IN_TALL_GRASS_DARK (1 << 22)
...
void MovementType_WalkInPlaceTurning(struct Sprite *sprite);
...
void MovementType_BlackBeltLoop(struct Sprite *sprite);
u8 MovementType_BlackBeltLoop_Step1(struct ObjectEvent *objectEvent, struct Sprite *sprite);
void MovementType_WalkBackAndForthScout(struct Sprite *sprite);
