...
extern const u16 gNamingScreenBwBg_Pal[];
extern const u16 gNamingScreenBwText_Pal[];
extern const u16 gNamingScreenBwSelectedButton_Pal[];
extern const u16 gNamingScreenBwCursor_Pal[];
extern const u16 gNamingScreenBwUnderscore_Pal[];
extern const u16 gNamingScreenBwPcIcon_Pal[];
extern const u16 gNamingScreenBwRival_Pal[];
extern const u32 gNamingScreenBwTiles_Gfx[];
extern const u32 gNamingScreenBwCursor_Gfx[];
extern const u32 gNamingScreenBwActiveCursorSmall_Gfx[];
extern const u32 gNamingScreenBwActiveCursorBig_Gfx[];
extern const u32 gNamingScreenBwUnderscore_Gfx[];
extern const u32 gNamingScreenBwPcIcon0_Gfx[];
extern const u32 gNamingScreenBwPcIcon1_Gfx[];
extern const u32 gNamingScreenBwRival_Gfx[];
extern const u32 gNamingScreenBwBackground_Tilemap[];
extern const u32 gNamingScreenBwButtons_Tilemap[];
extern const u32 gNamingScreenBwKeyboardUpper_Tilemap[];
extern const u32 gNamingScreenBwKeyboardLower_Tilemap[];
extern const u32 gNamingScreenBwKeyboardSymbols_Tilemap[];
