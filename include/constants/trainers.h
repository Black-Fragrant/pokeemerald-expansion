...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_RANGER_M,
    TRAINER_PIC_FRONT_RANGER_F,
    TRAINER_PIC_FRONT_CLERK_M,
    TRAINER_PIC_FRONT_CLERK_F,
    TRAINER_PIC_FRONT_CLERK_O,
    TRAINER_PIC_FRONT_JANITOR,
    TRAINER_PIC_FRONT_DANCER,
    TRAINER_PIC_FRONT_VETERAN_M,
    TRAINER_PIC_FRONT_VETERAN_F,
    TRAINER_PIC_FRONT_HIKER_BW,
    TRAINER_PIC_FRONT_HARLEQUIN,
    TRAINER_PIC_FRONT_BURGH,
...
#define TRAINER_ENCOUNTER_MUSIC_RANGER      22
#define TRAINER_ENCOUNTER_MUSIC_FUNNY       23
