...
enum
{
    ...
    FACILITY_CLASS_ARTIST,
    FACILITY_CLASS_CYCLIST_F,
    FACILITY_CLASS_CYCLIST_M,
    FACILITY_CLASS_POKE_KID_F,
    FACILITY_CLASS_POKE_KID_M,
    FACILITY_CLASS_VETERAN_F,
    FACILITY_CLASS_VETERAN_M,
    FACILITY_CLASS_WAITER,
    FACILITY_CLASS_WAITRESS,
    FACILITY_CLASS_WORKER_MINE,
    FACILITY_CLASS_WORKER_FREEZE,
    FACILITY_CLASS_BACKERS,
    FACILITY_CLASS_BAKER,
    FACILITY_CLASS_BACKPACKER_F,
    FACILITY_CLASS_BACKPACKER_M,
    FACILITY_CLASS_DEPOT_AGENT,
    FACILITY_CLASS_CLERK_F,
    FACILITY_CLASS_CLERK_M,
    FACILITY_CLASS_CLERK_M2,
    FACILITY_CLASS_DANCER,
    FACILITY_CLASS_DOCTOR,
    FACILITY_CLASS_HOOLIGANS,
    FACILITY_CLASS_HOOPSTER,
    FACILITY_CLASS_INFIELDER,
    FACILITY_CLASS_JANITOR,
    FACILITY_CLASS_LINEBACKER,
    FACILITY_CLASS_MOTORCYCLIST,
    FACILITY_CLASS_MUSICIAN,
    FACILITY_CLASS_NURSE,
    FACILITY_CLASS_NURSERY_AIDE,
    FACILITY_CLASS_PILOT,
    FACILITY_CLASS_PRESCHOOLER_F,
    FACILITY_CLASS_PRESCHOOLER_M,
    FACILITY_CLASS_THE_RICHES,
    FACILITY_CLASS_SMASHER,
    FACILITY_CLASS_STRIKER,
    FACILITY_CLASS_SUBWAY_BOSS,
    FACILITY_CLASS_SCIENTIST_M,
    FACILITY_CLASS_SCIENTIST_F,
    FACILITY_CLASS_ROUGHNECK,
    FACILITY_CLASS_BIKER,
    FACILITY_CLASS_POLICEMAN,
    FACILITY_CLASS_HARLEQUIN,
    FACILITY_CLASS_MAID,
    FACILITY_CLASS_SOCIALITE,
    FACILITY_CLASS_ACE_TRAINER_M,
    FACILITY_CLASS_ACE_TRAINER_F,
    FACILITY_CLASS_RANGER_M,
    FACILITY_CLASS_RANGER_F,
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_RANGER,
    TRAINER_CLASS_GAMEFREAK,
    TRAINER_CLASS_HARLEQUIN,
...
#define TRAINER_ENCOUNTER_MUSIC_INTERVIEWER 11
#define TRAINER_ENCOUNTER_MUSIC_RICH        12 // Used for Rich Boys and Gentlemen
#define TRAINER_ENCOUNTER_MUSIC_YOUNGSTER   13
#define TRAINER_ENCOUNTER_MUSIC_LASS        14
#define TRAINER_ENCOUNTER_MUSIC_CLERK       15
#define TRAINER_ENCOUNTER_MUSIC_PLASMA      16
#define TRAINER_ENCOUNTER_MUSIC_WOMAN       17
#define TRAINER_ENCOUNTER_MUSIC_KID         18
#define TRAINER_ENCOUNTER_MUSIC_CRUEL       19
#define TRAINER_ENCOUNTER_MUSIC_SCIENTIST   20
#define TRAINER_ENCOUNTER_MUSIC_RANGER      21
#define TRAINER_ENCOUNTER_MUSIC_FUNNY       22
#define TRAINER_ENCOUNTER_MUSIC_HIKER       23
#define TRAINER_ENCOUNTER_MUSIC_CYCLIST     24
#define TRAINER_ENCOUNTER_MUSIC_GENTLEMAN   25
#define TRAINER_ENCOUNTER_MUSIC_DANCER      26
