...
#define MULTI_POKEMON_RPS                                159
#define MULTI_BW_STARTER                                 160
#define MULTI_TRAINER_SCHOOL_QUIZ                        161
#define MULTI_FENNEL_LAPTOP                              162
#define MULTI_AMANITA_QUESTION                           163
#define MULTI_TRAINERSCHOOL_BLACKBOARD                   164
#define MULTI_NCG_QUESTIONS_1                            165
#define MULTI_NCG_QUESTIONS_2                            166
#define MULTI_NACRENE_STARTERS                           167
