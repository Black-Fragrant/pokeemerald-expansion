...
enum
{
    ...
    MULTI_POKEMON_RPS,
    MULTI_BW_STARTER,
    MULTI_TRAINER_SCHOOL_QUIZ,
    MULTI_FENNEL_LAPTOP,
    MULTI_AMANITA_QUESTION,
    MULTI_TRAINERSCHOOL_BLACKBOARD,
    MULTI_NCG_QUESTIONS_1,
    MULTI_NCG_QUESTIONS_2,
    MULTI_NACRENE_STARTERS,
    MULTI_CASTELIA_ELEVATOR_47_55,
    MULTI_CASTELIA_ELEVATOR_1_47,
    MULTI_CASTELIA_ELEVATOR_1_55,
    MULTI_CASTELIA_ELEVATOR_1,
    MULTI_CASTELIA_ELEVATOR_2,
    MULTI_CASTELIA_ELEVATOR_11,
    MULTI_CASTELIA_ELEVATOR_22,
    MULTI_CASTELIA_ELEVATOR_47,
    MULTI_CASTELIA_EVOLUTION_STONE,
    MULTI_CASTELIA_CONES,
    MULTI_PAHQ_SCIENTIST,
    MULTI_PAHQ_SURVEY_BATTLEORTRADE,
    MULTI_PAHQ_SURVEY_POKEMON,
    MULTI_PAHQ_SURVEY_LIVE,
    MULTI_PAHQ_SURVEY_MORE,
    MULTI_PAHQ_SURVEY_IMPORTANT,
    MULTI_PAHQ_SURVEY_BRAINBRAWN,
    MULTI_PAHQ_SURVEY_PVALUE,
    MULTI_PAHQ_SURVEY_PTYPE,
    MULTI_PAHQ_SURVEY_SEASON,
    MULTI_PAHQ_SURVEY_FOOD,
    MULTI_PAHQ_SURVEY_COLOR,
    MULTI_PAHQ_SURVEY_MUSIC,
    MULTI_PAHQ_SURVEY_TV,
    MULTI_PAHQ_SURVEY_MOVIE,
    MULTI_PAHQ_SURVEY_STIME,
    MULTI_PAHQ_SURVEY_SSUBJECT,
    MULTI_PAHQ_SURVEY_WSUBJECT,
    MULTI_PAHQ_SURVEY_FPLACES,
    MULTI_PAHQ_SURVEY_HOLIDAY,
    MULTI_PAHQ_SURVEY_SPORT,
    MULTI_PAHQ_SURVEY_PFUN,
    MULTI_PAHQ_SURVEY_BECOME,
    MULTI_STUDIO_CASTELIA_BERRY,
};
