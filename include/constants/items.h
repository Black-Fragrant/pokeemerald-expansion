...
enum __attribute__((packed)) Item
{
    ...
    ITEM_BRIDGE_MAIL_D = FIRST_MAIL_INDEX,
    ITEM_BRIDGE_MAIL_M = 200,
    ITEM_BRIDGE_MAIL_S = 201,
    ITEM_BRIDGE_MAIL_T = 202,
    ITEM_BRIDGE_MAIL_V = 203,
    ITEM_FAVORED_MAIL = 204,
    ITEM_GREET_MAIL = 205,
    ITEM_INQUIRY_MAIL = 206,
    ITEM_LIKE_MAIL = 207,
    ITEM_REPLY_MAIL = 208,
    ITEM_RSVP_MAIL = 209,
    ITEM_THANKS_MAIL = 210,
