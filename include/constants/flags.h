...
#define FLAG_DN_FLAG_SEARCHING               0x1DE
#define FLAG_DN_FLAG_DEXNAV_GET              0x1DF
#define FLAG_DN_FLAG_DETECTOR_MODE           0x1E0
...
#define FLAG_SYS_BP_SHOP                            (SYSTEM_FLAGS + 0x37)
#define FLAG_SYS_GOURMET_MANIAC                     (SYSTEM_FLAGS + 0x38)
