...
#define MOVEMENT_TYPE_BLACK_BELT_LOOP                  0x59
#define MOVEMENT_TYPE_WALK_DOWN_AND_UP_SCOUT_EVERY_2_STEPS         0x5A
#define MOVEMENT_TYPE_WALK_UP_AND_DOWN_SCOUT_EVERY_2_STEPS         0x5B
#define MOVEMENT_TYPE_WALK_LEFT_AND_RIGHT_SCOUT_EVERY_2_STEPS      0x5C
#define MOVEMENT_TYPE_WALK_RIGHT_AND_LEFT_SCOUT_EVERY_2_STEPS      0x5D
#define MOVEMENT_TYPE_WALK_DOWN_AND_UP_SCOUT_EVERY_STEP            0x5E
#define MOVEMENT_TYPE_WALK_UP_AND_DOWN_SCOUT_EVERY_STEP            0x5F
#define MOVEMENT_TYPE_WALK_LEFT_AND_RIGHT_SCOUT_EVERY_STEP         0x60
#define MOVEMENT_TYPE_WALK_RIGHT_AND_LEFT_SCOUT_EVERY_STEP         0x61
#define MOVEMENT_TYPE_WALK_IN_PLACE_ROTATE_CLOCKWISE               0x62
#define MOVEMENT_TYPE_WALK_IN_PLACE_ROTATE_COUNTERCLOCKWISE        0x63
#define MOVEMENT_TYPE_WALK_IN_PLACE_LOOK_AROUND                    0x64
#define NUM_MOVEMENT_TYPES                                         0x65
...
#define MOVEMENT_ACTION_CHEREN_TAP_SHOES                0xB6
#define MOVEMENT_ACTION_BIANCA_TIP_HAT                  0xB7
#define MOVEMENT_ACTION_ALDER_HAIR_SHAKE                0xB8
#define MOVEMENT_ACTION_GHETSIS_RAISE_HAND              0xB9
#define MOVEMENT_ACTION_N_SHAKE_HEAD                    0xC0
#define MOVEMENT_ACTION_N_SUMMON                        0xC1
#define MOVEMENT_ACTION_N_RAISE_ARMS                    0xC2
#define MOVEMENT_ACTION_SHADOW_TRIAD_TELEPORT_IN        0xC3
#define MOVEMENT_ACTION_SHADOW_TRIAD_TELEPORT_OUT       0xC4

#define MOVEMENT_ACTION_EMOTE_ELLIPSIS         			0xC5
...
#define ANIM_CHEREN_TAP_SHOES (ANIM_STD_COUNT + 1)
#define ANIM_BIANCA_TIP_HAT (ANIM_STD_COUNT + 2)
#define ANIM_ALDER_HAIR_SHAKE (ANIM_STD_COUNT + 3)
#define ANIM_GHETSIS_RAISE_HAND (ANIM_STD_COUNT + 4)
#define ANIM_N_SHAKE_HEAD (ANIM_STD_COUNT + 5)
#define ANIM_N_SUMMON (ANIM_STD_COUNT + 6)
#define ANIM_N_RAISE_ARMS (ANIM_STD_COUNT + 7)
#define ANIM_SHADOW_TRIAD_TELEPORT_IN (ANIM_STD_COUNT + 8)
#define ANIM_SHADOW_TRIAD_TELEPORT_OUT (ANIM_STD_COUNT + 9)
