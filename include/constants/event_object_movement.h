...
#define MOVEMENT_ACTION_CHEREN_TAP_SHOES                0xB2
#define MOVEMENT_ACTION_BIANCA_TIP_HAT                  0xB3
#define MOVEMENT_ACTION_ALDER_HAIR_SHAKE                0xB4
#define MOVEMENT_ACTION_GHETSIS_RAISE_HAND              0xB5
#define MOVEMENT_ACTION_N_SHAKE_HEAD                    0xB6
#define MOVEMENT_ACTION_N_SUMMON                        0xB7
#define MOVEMENT_ACTION_N_RAISE_ARMS                    0xB8
#define MOVEMENT_ACTION_SHADOW_TRIAD_TELEPORT_IN        0xB9
#define MOVEMENT_ACTION_SHADOW_TRIAD_TELEPORT_OUT       0xBA
