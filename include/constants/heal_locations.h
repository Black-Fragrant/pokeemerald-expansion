...
#define HEAL_LOCATION_NUVEMA_TOWN 23
#define HEAL_LOCATION_COUNT 24
#define HEAL_LOCATION_ACCUMULA_TOWN 25
#define HEAL_LOCATION_STRIATON_CITY_1 26
#define HEAL_LOCATION_STRIATON_CITY_2 27
