...
#define OBJ_EVENT_PAL_TAG_PIKACHUOW               0x11AA
#define OBJ_EVENT_PAL_TAG_VICTINIOW               0x11AB
#define OBJ_EVENT_PAL_TAG_KROKOROKOW              0x11AC
#define OBJ_EVENT_PAL_TAG_ZENMODEOW               0x11AD
#define OBJ_EVENT_PAL_TAG_VOLCARONAOW             0x11AE
#define OBJ_EVENT_PAL_TAG_CLERKO                  0x11AF
#define OBJ_EVENT_PAL_TAG_FLAG_POLE               0x11B0
#define OBJ_EVENT_PAL_TAG_GIFT_BOX                0x11B1
#define OBJ_EVENT_PAL_TAG_GOLD_BALL               0x11B2
#define OBJ_EVENT_PAL_TAG_CONE                    0x11B3
#define OBJ_EVENT_PAL_TAG_BOAT_RED                0x11B4
#define OBJ_EVENT_PAL_TAG_BOAT_BLUE               0x11B5
#define OBJ_EVENT_PAL_TAG_BOAT_YELLOW             0x11B6
#define OBJ_EVENT_PAL_TAG_BOAT_BLACK              0x11B7
#define OBJ_EVENT_PAL_TAG_BOAT_ROYAL              0x11B8
#define OBJ_EVENT_PAL_TAG_TRAIN_SINGLE            0x11B9
#define OBJ_EVENT_PAL_TAG_TRAIN_SUPER_SINGLE      0x11BA
#define OBJ_EVENT_PAL_TAG_TRAIN_DOUBLE            0x11BB
#define OBJ_EVENT_PAL_TAG_TRAIN_SUPER_DOUBLE      0x11BC
#define OBJ_EVENT_PAL_TAG_TRAIN_WIFI              0x11BD
#define OBJ_EVENT_PAL_TAG_TRAIN_MULTI             0x11BE
#define OBJ_EVENT_PAL_TAG_TRAIN_SUPER_MULTI       0x11BF
#define OBJ_EVENT_PAL_TAG_TRAIN_ANVIL             0x11C0
#define OBJ_EVENT_PAL_TAG_PLAYER_RED              0x11C1
#define OBJ_EVENT_PAL_TAG_PLAYER_RED_REFLECTION   0x11C2
#define OBJ_EVENT_PAL_TAG_PLAYER_GREEN            0x11C3
#define OBJ_EVENT_PAL_TAG_PLAYER_GREEN_REFLECTION 0x11C4
#define OBJ_EVENT_PAL_TAG_NPC_BLUE                0x11C5
#define OBJ_EVENT_PAL_TAG_NPC_PINK                0x11C6
#define OBJ_EVENT_PAL_TAG_NPC_GREEN               0x11C7
#define OBJ_EVENT_PAL_TAG_NPC_WHITE               0x11C8
#define OBJ_EVENT_PAL_TAG_NPC_BLUE_REFLECTION     0x11C9
#define OBJ_EVENT_PAL_TAG_NPC_PINK_REFLECTION     0x11CA
#define OBJ_EVENT_PAL_TAG_NPC_GREEN_REFLECTION    0x11CB
#define OBJ_EVENT_PAL_TAG_NPC_WHITE_REFLECTION    0x11CC
#define OBJ_EVENT_PAL_TAG_METEORITE               0x11CD
#define OBJ_EVENT_PAL_TAG_SEAGALLOP               0x11CE
#define OBJ_EVENT_PAL_TAG_SS_ANNE                 0x11CF
