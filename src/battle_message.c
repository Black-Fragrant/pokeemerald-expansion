...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_WALLYUSEDITEM]                        = COMPOUND_STRING("Professor Juniper used a {B_LAST_ITEM}!"), //no decapitalize until it is everywhere
    ...
    [STRINGID_YOUTHROWABALLNOWRIGHT]                = COMPOUND_STRING("The wild Pokémon is low on HP, throw a Poké Ball now!"),
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_PEDAL]              = STRINGID_ITISRAINING,
};
...
const u8 gText_WhatWillWallyDo[] = _("Professor Juniper\nis deciding...");
