...
{
    [FRONTIER_MODE_SINGLES]        = FRONTIER_PARTY_SIZE,         // 3
    [FRONTIER_MODE_SUPER_SINGLES]  = FRONTIER_PARTY_SIZE,         // 3
    [FRONTIER_MODE_DOUBLES]        = FRONTIER_DOUBLES_PARTY_SIZE, // 4
    [FRONTIER_MODE_SUPER_DOUBLES]  = FRONTIER_DOUBLES_PARTY_SIZE, // 4
    [FRONTIER_MODE_MULTIS]         = FRONTIER_MULTI_PARTY_SIZE,   // 2
    [FRONTIER_MODE_SUPER_MULTIS]   = FRONTIER_MULTI_PARTY_SIZE,   // 2
    [FRONTIER_MODE_LINK_MULTIS]    = FRONTIER_MULTI_PARTY_SIZE,   // 2
};
