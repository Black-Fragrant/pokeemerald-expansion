...
static const u32 sTitleScreenRayquazaGfx[] = INCGFX_U32("graphics/title_screen/reshiram.png", ".4bpp.smol");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/reshiram.bin.smolTM");
...
void CB2_InitTitleScreen(void)
{
    ...
    case 4:
        ...
        SetGpuReg(REG_OFFSET_BG2X_L, -4 * 256);
        ...
        SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_1
                                    ...
                                    | DISPCNT_WIN0_ON
                                    | DISPCNT_OBJWIN_ON);
        m4aSongNumStart(MUS_BW_TITLE_SCREEN);
        gMain.state = 5;
        break;
    case 5:
