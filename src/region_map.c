...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_NUVEMA_TOWN] = {MAP_GROUP(MAP_NUVEMA_TOWN), MAP_NUM(MAP_NUVEMA_TOWN), HEAL_LOCATION_NUVEMA_TOWN},
    [MAPSEC_ACCUMULA_TOWN] = {MAP_GROUP(MAP_ACCUMULA_TOWN), MAP_NUM(MAP_ACCUMULA_TOWN), HEAL_LOCATION_ACCUMULA_TOWN},
    [MAPSEC_STRIATON_CITY] = {MAP_GROUP(MAP_STRIATON_CITY), MAP_NUM(MAP_STRIATON_CITY), HEAL_LOCATION_STRIATON_CITY},
    [MAPSEC_NACRENE_CITY] = {MAP_GROUP(MAP_NACRENE_CITY), MAP_NUM(MAP_NACRENE_CITY), HEAL_LOCATION_NACRENE_CITY},
    [MAPSEC_CASTELIA_CITY] = {MAP_GROUP(MAP_CASTELIA_CITY_SOUTH_BANK), MAP_NUM(MAP_CASTELIA_CITY_SOUTH_BANK), HEAL_LOCATION_CASTELIA_CITY_SOUTH_BANK},
    [MAPSEC_NIMBASA_CITY] = {MAP_GROUP(MAP_NIMBASA_CITY), MAP_NUM(MAP_NIMBASA_CITY), HEAL_LOCATION_NIMBASA_CITY},
    ...
    [MAPSEC_ROUTE_4_POKECENTER] = {MAP_GROUP(MAP_ROUTE4_FRLG), MAP_NUM(MAP_ROUTE4_FRLG), HEAL_LOCATION_ROUTE4},
    [MAPSEC_ROUTE_10_POKECENTER] = {MAP_GROUP(MAP_ROUTE10_FRLG), MAP_NUM(MAP_ROUTE10_FRLG), HEAL_LOCATION_ROUTE10},
    [MAPSEC_ROUTE_1] = {MAP_GROUP(MAP_ROUTE1_FRLG), MAP_NUM(MAP_ROUTE1_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_2] = {MAP_GROUP(MAP_ROUTE2_FRLG), MAP_NUM(MAP_ROUTE2_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_3] = {MAP_GROUP(MAP_ROUTE3_FRLG), MAP_NUM(MAP_ROUTE3_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_4] = {MAP_GROUP(MAP_ROUTE4_FRLG), MAP_NUM(MAP_ROUTE4_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_5] = {MAP_GROUP(MAP_ROUTE5_FRLG), MAP_NUM(MAP_ROUTE5_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_6] = {MAP_GROUP(MAP_ROUTE6_FRLG), MAP_NUM(MAP_ROUTE6_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_7] = {MAP_GROUP(MAP_ROUTE7_FRLG), MAP_NUM(MAP_ROUTE7_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_8] = {MAP_GROUP(MAP_ROUTE8_FRLG), MAP_NUM(MAP_ROUTE8_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_9] = {MAP_GROUP(MAP_ROUTE9_FRLG), MAP_NUM(MAP_ROUTE9_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_10] = {MAP_GROUP(MAP_ROUTE10_FRLG), MAP_NUM(MAP_ROUTE10_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_11] = {MAP_GROUP(MAP_ROUTE11_FRLG), MAP_NUM(MAP_ROUTE11_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_12] = {MAP_GROUP(MAP_ROUTE12_FRLG), MAP_NUM(MAP_ROUTE12_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_13] = {MAP_GROUP(MAP_ROUTE13_FRLG), MAP_NUM(MAP_ROUTE13_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_14] = {MAP_GROUP(MAP_ROUTE14_FRLG), MAP_NUM(MAP_ROUTE14_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_15] = {MAP_GROUP(MAP_ROUTE15_FRLG), MAP_NUM(MAP_ROUTE15_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_16] = {MAP_GROUP(MAP_ROUTE16_FRLG), MAP_NUM(MAP_ROUTE16_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_17] = {MAP_GROUP(MAP_ROUTE17_FRLG), MAP_NUM(MAP_ROUTE17_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_18] = {MAP_GROUP(MAP_ROUTE18_FRLG), MAP_NUM(MAP_ROUTE18_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_19] = {MAP_GROUP(MAP_ROUTE19_FRLG), MAP_NUM(MAP_ROUTE19_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_20] = {MAP_GROUP(MAP_ROUTE20_FRLG), MAP_NUM(MAP_ROUTE20_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_21] = {MAP_GROUP(MAP_ROUTE21_NORTH_FRLG), MAP_NUM(MAP_ROUTE21_NORTH_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_22] = {MAP_GROUP(MAP_ROUTE22_FRLG), MAP_NUM(MAP_ROUTE22_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_23] = {MAP_GROUP(MAP_ROUTE23_FRLG), MAP_NUM(MAP_ROUTE23_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_24] = {MAP_GROUP(MAP_ROUTE24_FRLG), MAP_NUM(MAP_ROUTE24_FRLG), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_25] = {MAP_GROUP(MAP_ROUTE25_FRLG), MAP_NUM(MAP_ROUTE25_FRLG), HEAL_LOCATION_NONE},
