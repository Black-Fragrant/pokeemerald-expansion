...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, TRAINER_DUMMY, TRAINER_ANDRES_3, TRAINER_ANDRES_4, TRAINER_ANDRES_5, MAP_ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, MAP_ROUTE111),
    [REMATCH_LOLA] = REMATCH(TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, MAP_ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, MAP_ROUTE109),
    ...
    [REMATCH_BROOKE] = REMATCH(TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, MAP_ROUTE111),
    [REMATCH_WILTON] = REMATCH(TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, MAP_ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, MAP_MT_PYRE_6F),
    [REMATCH_CINDY] = REMATCH(TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, MAP_ROUTE104),
    [REMATCH_THALIA] = REMATCH(TRAINER_DUMMY, TRAINER_THALIA_2, TRAINER_THALIA_3, TRAINER_THALIA_4, TRAINER_THALIA_5, MAP_ABANDONED_SHIP_ROOMS_1F),
    [REMATCH_JESSICA] = REMATCH(TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, MAP_ROUTE121),
    [REMATCH_WINSTON] = REMATCH(TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, MAP_ROUTE104),
    [REMATCH_STEVE] = REMATCH(TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, MAP_ROUTE114),
    [REMATCH_TONY] = REMATCH(TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, MAP_ROUTE107),
    [REMATCH_NOB] = REMATCH(TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, TRAINER_DUMMY, MAP_ROUTE115),
    ...
    [REMATCH_EDWIN] = REMATCH(TRAINER_DUMMYWIN_1, TRAINER_DUMMYWIN_2, TRAINER_DUMMYWIN_3, TRAINER_DUMMYWIN_4, TRAINER_DUMMYWIN_5, MAP_ROUTE110),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_DUMMY, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MAP_MT_PYRE_3F),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_DUMMY, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MAP_MT_CHIMNEY),
...
static bool8 CheckSilphScopeInPokemonTower(u16 mapGroup, u16 mapNum)
{
    if (mapGroup == MAP_GROUP(MAP_POKEMON_TOWER_1F)
     ...
     && !(CheckBagHasItem(ITEM_VS_RECORDER, 1)))
        return TRUE;
    else
        return FALSE;
}
...
{
    CreateMaleMon(&gParties[B_TRAINER_OPPONENT_A][0], SPECIES_PATRAT, 5);
    LockPlayerFieldControls();
...
void StartMarowakBattle(void)
{
    ...
    if (CheckBagHasItem(ITEM_VS_RECORDER, 1))
    {
...
enum BattleEnvironments BattleSetup_GetEnvironmentId(void)
{
    ...
    if (MetatileBehavior_IsRelicCastle(tileBehavior))
        return BATTLE_ENVIRONMENT_SAND;
...
void PlayTrainerEncounterMusic(void)
{
    ...
    case TRAINER_ENCOUNTER_MUSIC_RICH:
        ...
        break;
    // Fire Black music categories start here
    case TRAINER_ENCOUNTER_MUSIC_YOUNGSTER:
        music = MUS_BW_SPOTTED_YOUNGSTER;
        break;
    ...
    case TRAINER_ENCOUNTER_MUSIC_PLASMA:
        ...
        break;
    case TRAINER_ENCOUNTER_MUSIC_WOMAN:
        music = MUS_BW_SPOTTED_PARASOL_LADY;
        break;
    case TRAINER_ENCOUNTER_MUSIC_KID:
        music = MUS_BW_SPOTTED_KID;
        break;
    case TRAINER_ENCOUNTER_MUSIC_CRUEL:
        music = MUS_BW_SPOTTED_PSYCHIC;
        break;
    case TRAINER_ENCOUNTER_MUSIC_SCIENTIST:
        music = MUS_BW_SPOTTED_SCIENTIST;
        break;
    ...
    case TRAINER_ENCOUNTER_MUSIC_HIKER:
        music = MUS_BW_SPOTTED_HIKER;
        break;
    case TRAINER_ENCOUNTER_MUSIC_CYCLIST:
        music = MUS_BW_SPOTTED_CYCLIST;
        break;
    case TRAINER_ENCOUNTER_MUSIC_GENTLEMAN:
        music = MUS_BW_SPOTTED_GENTLEMEN;
        break;
    case TRAINER_ENCOUNTER_MUSIC_DANCER:
        music = MUS_BW_SPOTTED_ROUGHNECK;
        break;
    default:
