...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_WILTON] = REMATCH(TRAINER_DUMMY28, TRAINER_DUMMY05, TRAINER_DUMMY06, TRAINER_DUMMY07, TRAINER_DUMMY08, MAP_ROUTE111),
...
{
    CreateMaleMon(&gEnemyParty[0], SPECIES_PATRAT, 5);
    LockPlayerFieldControls();
