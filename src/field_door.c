...
static const u8 sDoorAnimTiles_NuvemaHouse[] = INCGFX_U8("graphics/door_anims/nuvema_house.png", ".4bpp");
static const u8 sDoorAnimTiles_NuvemaLab[] = INCGFX_U8("graphics/door_anims/nuvema_lab.png", ".4bpp");
static const u8 sDoorAnimTiles_AccumulaHouse_1[] = INCGFX_U8("graphics/door_anims/accumula_house_1.png", ".4bpp");
static const u8 sDoorAnimTiles_AccumulaHouse_2[] = INCGFX_U8("graphics/door_anims/accumula_house_2.png", ".4bpp");
static const u8 sDoorAnimTiles_StraitonHouse_1[] = INCGFX_U8("graphics/door_anims/straiton_house_1.png", ".4bpp");
static const u8 sDoorAnimTiles_StraitonHouse_2[] = INCGFX_U8("graphics/door_anims/straiton_house_2.png", ".4bpp");
...
#endif // !IS_FRLG
    {METATILE_Nuvema_House_Door,                            &gTileset_Nuvema, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_NuvemaHouse, sDoorAnimPalettes_NuvemaHouse},
    {METATILE_Nuvema_Lab_Door,                              &gTileset_Nuvema, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_NuvemaLab, sDoorAnimPalettes_NuvemaLab},
    {METATILE_Accumula_House_1,                             &gTileset_Accumula, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_AccumulaHouse_1, sDoorAnimPalettes_AccumulaHouse_1},
    {METATILE_Accumula_House_2,                             &gTileset_Accumula, DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_AccumulaHouse_2, sDoorAnimPalettes_AccumulaHouse_2},
...
{
    const struct DoorAnimFrame *doorAnimFrames = gMapHeader.mapLayout->isFrlg ? sDoorAnimFrames_OpenSmallFrlg : sDoorAnimFrames_OpenSmallFrlg;
...
static s8 StartDoorOpenAnimation(const struct DoorGraphics *gfx, u32 x, u32 y)
{
    ...
    {
        if (gfx->size == 2)
            return StartDoorAnimationTask(gfx, gMapHeader.mapLayout->isFrlg ? sDoorAnimFrames_OpenLargeFrlg : sDoorAnimFrames_OpenLargeFrlg, x, y);
        else
            return StartDoorAnimationTask(gfx, gMapHeader.mapLayout->isFrlg ? sDoorAnimFrames_OpenSmallFrlg : sDoorAnimFrames_OpenSmallFrlg, x, y);
    }
}
...
static s8 StartDoorCloseAnimation(const struct DoorGraphics *gfx, u32 x, u32 y)
{
    ...
    if (gfx == NULL)
        ...
        return StartDoorAnimationTask(gfx, gMapHeader.mapLayout->isFrlg ? sDoorAnimFrames_CloseSmallFrlg : sDoorAnimFrames_CloseSmallFrlg, x, y);
}
