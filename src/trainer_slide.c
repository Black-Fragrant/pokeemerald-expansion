...
static const u8* const sTrainerSlides[DIFFICULTY_COUNT][TRAINER_PARTNER(PARTNER_COUNT)][TRAINER_SLIDE_COUNT] =
{
    [DIFFICULTY_NORMAL] =
    {
        [TRAINER_BIANCA_NUVEMA_TOWN_1] =  {
            [TRAINER_SLIDE_OPPONENT_LAST_HALF_HP] = COMPOUND_STRING("Eek! Ouch!\pI won't let you get away\nwith that!{PAUSE_UNTIL_PRESS}"),
        },
        ...
        [TRAINER_CHEREN_NUVEMA_TOWN_1] =  {    
            [TRAINER_SLIDE_OPPONENT_LAST_HALF_HP] = COMPOUND_STRING("I've finally become a\nTrainer...\pEverything starts from here!{PAUSE_UNTIL_PRESS}"),
        },
        ...
        [TRAINER_N_ACCUMULA_TOWN] =  {
            [TRAINER_SLIDE_OPPONENT_LAST_HALF_HP] = COMPOUND_STRING("More! Let me hear the\nvoice of your Pokémon!{PAUSE_UNTIL_PRESS}"),
        },

        [TRAINER_BIANCA_ROUTE_2_1] = {
            [TRAINER_SLIDE_BEFORE_FIRST_TURN] = COMPOUND_STRING("B-both my Pokémon and I are\ngoing to give it our all!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_OPPONENT_LAST_SWITCHIN] = COMPOUND_STRING("OK! This little one\nis up next!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_OPPONENT_LAST_LOW_HP] = COMPOUND_STRING("Uh-oh...\nAm I in trouble?!{PAUSE_UNTIL_PRESS}"),
        },
        ...
        [TRAINER_CHEREN_TRAINER_SCHOOL_1] = {
            ...
            [TRAINER_SLIDE_OPPONENT_LAST_SWITCHIN] = COMPOUND_STRING("It's important to choose\nwhich item your Pokémon\lholds...{PAUSE_UNTIL_PRESS}"),
        },
        ...
        [TRAINER_CHILI_STRIATON_GYM] =  {
            [TRAINER_SLIDE_ATTACKER_LANDS_FIRST_STAB_MOVE] = COMPOUND_STRING("As if that would work on my Pokémon!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_OPPONENT_LAST_SWITCHIN] = COMPOUND_STRING("It's not over yet!\nOne more left!\pThis is where I\ngive it my all!{PAUSE_UNTIL_PRESS}"),
        },

        [TRAINER_CRESS_STRIATON_GYM] =  {
            [TRAINER_SLIDE_ATTACKER_LANDS_FIRST_STAB_MOVE] = COMPOUND_STRING("I see...\nThat might be a good attack.{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_OPPONENT_LAST_SWITCHIN] = COMPOUND_STRING("I'll put all my hopes\non my last Pokémon!{PAUSE_UNTIL_PRESS}"),
        },

        [TRAINER_CILAN_STRIATON_GYM] = {
            [TRAINER_SLIDE_ATTACKER_LANDS_FIRST_STAB_MOVE] = COMPOUND_STRING("Ah! My Pokémon!{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_OPPONENT_LAST_SWITCHIN] = COMPOUND_STRING("Huh? Could it be?\pCould I have only\none Pokémon left?{PAUSE_UNTIL_PRESS}"),
        },

        [TRAINER_CHEREN_ROUTE_3_1] = {
            [TRAINER_SLIDE_ATTACKER_LANDS_FIRST_STAB_MOVE] = COMPOUND_STRING("Ugh! You choose a good\nmove, as usual.{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_OPPONENT_LAST_SWITCHIN] = COMPOUND_STRING("With my knowledge,\nI can bring out the strength\lof my Pokémon!{PAUSE_UNTIL_PRESS}"),
        },
        ...
        [TRAINER_LENORA_NACRENE_GYM] =  {
            [TRAINER_SLIDE_ATTACKER_LANDS_FIRST_STAB_MOVE] = COMPOUND_STRING("Now, with that move,\nI'm beginning to see what kind\lof Trainer you are.{PAUSE_UNTIL_PRESS}"),
            [TRAINER_SLIDE_OPPONENT_LAST_SWITCHIN] = COMPOUND_STRING("No matter how grim the situation,\nI'll use my research skills to\lfind a winning strategy!{PAUSE_UNTIL_PRESS}"),
        },
    },
};
