...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_NURSE] = { _("Nurse"), 1 },
    [TRAINER_CLASS_NURSERY_AIDE] = { _("Nursery Aide"), 10 },
    [TRAINER_CLASS_PILOT] = { _("Pilot"), 1 },
    [TRAINER_CLASS_PRESCHOOLER] = { _("Preschooler"), 1 },
    ...
    [TRAINER_CLASS_TEAM_PLASMA] = { _("Team Plasma"), 1 },
    [TRAINER_CLASS_SCIENTIST] = { _("Scientist"), 1 },
    [TRAINER_CLASS_RANGER] = { _("Ranger"), 1 },
};
