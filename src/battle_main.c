...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_PKMN_TRAINER_2] = { _("{PKMN} Trainer"), 25 },
    ...
    [TRAINER_CLASS_BLACK_BELT] = { _("Black Belt"), 8, BALL_ULTRA }, //updated to bw money rates
    ...
    [TRAINER_CLASS_SCHOOL_KID] = { _("School Kid"), 5 }, //updated to bw money rates
    ...
    [TRAINER_CLASS_BATTLE_GIRL] = { _("Battle Girl"), 8 }, //updated to bw money rates
    [TRAINER_CLASS_PARASOL_LADY] = { _("Parasol Lady"), 10 },
    [TRAINER_CLASS_SWIMMER_F] = { _("Swimmer♀"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("Twins"), 2 },
    ...
    //BW
    [TRAINER_CLASS_ARTIST] = { _("Artist"), 1 },
    [TRAINER_CLASS_CYCLIST] = { _("Cyclist"), 1 },
    [TRAINER_CLASS_POKE_KID] = { _("Poké Kid"), 1 },
    [TRAINER_CLASS_VETERAN] = { _("Veteran"), 1 },
    [TRAINER_CLASS_WAITER] = { _("Waiter"), 10 }, //updated to bw money rates
    [TRAINER_CLASS_WAITRESS] = { _("Waitress"), 10 }, //updated to bw money rates
    [TRAINER_CLASS_WORKER] = { _("Worker"), 1 },
    [TRAINER_CLASS_BACKERS] = { _("Backers"), 1 },
    [TRAINER_CLASS_BAKER] = { _("Baker"), 1 },
    [TRAINER_CLASS_BACKPACKER] = { _("Backpacker"), 1 },
    [TRAINER_CLASS_DEPOT_AGENT] = { _("Depot Agent"), 1 },
    [TRAINER_CLASS_CLERK] = { _("Clerk"), 1 },
    [TRAINER_CLASS_DANCER] = { _("Dancer"), 1 },
    [TRAINER_CLASS_DOCTOR] = { _("Doctor"), 1 },
    [TRAINER_CLASS_HOOLIGANS] = { _("Hooligans"), 1 },
    [TRAINER_CLASS_HOOPSTER] = { _("Hoopster"), 1 },
    [TRAINER_CLASS_INFIELDER] = { _("Infielder"), 1 },
    [TRAINER_CLASS_JANITOR] = { _("Janitor"), 1 },
    [TRAINER_CLASS_LINEBACKER] = { _("Linebacker"), 1 },
    [TRAINER_CLASS_MOTORCYCLIST] = { _("Motorcyclist"), 1 },
    [TRAINER_CLASS_MUSICIAN] = { _("Musician"), 1 },
    [TRAINER_CLASS_NURSE] = { _("Nurse"), 10 }, //updated to bw money rates
    [TRAINER_CLASS_NURSERY_AIDE] = { _("Nursery Aide"), 10 }, //updated to bw money rates
    [TRAINER_CLASS_PILOT] = { _("Pilot"), 1 },
    [TRAINER_CLASS_PRESCHOOLER] = { _("Preschooler"), 1 }, //updated to bw money rates
    [TRAINER_CLASS_THE_RICHES] = { _("The Riches"), 1 },
    [TRAINER_CLASS_SMASHER] = { _("Smasher"), 1 },
    [TRAINER_CLASS_STRIKER] = { _("Striker"), 1 },
    [TRAINER_CLASS_SUBWAY_BOSS] = { _("Subway Boss"), 1 },
    [TRAINER_CLASS_TEAM_PLASMA] = { _("Team Plasma"), 10 }, //updated to bw money rates
    [TRAINER_CLASS_SCIENTIST] = { _("Scientist"), 12 }, //updated to bw money rates
