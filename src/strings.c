...
const u8 gText_SuperSingleBattleRoomResults[] = _("{PLAYER}'s Super Single Battle Room Results");
const u8 gText_SuperDoubleBattleRoomResults[] = _("{PLAYER}'s Super Double Battle Room Results");
const u8 gText_SuperMultiBattleRoomResults[]  = _("{PLAYER}'s Super Multi Battle Room Results");
