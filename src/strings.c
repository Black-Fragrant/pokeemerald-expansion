...
const u8 gText_LanettesPC[] = _("Amanita's PC");
...
const u8 gText_SingleBattleRoomResults[] = _("{PLAYER}'s Single Battle Subway Results");
const u8 gText_DoubleBattleRoomResults[] = _("{PLAYER}'s Double Battle Subway Results");
const u8 gText_MultiBattleRoomResults[] = _("{PLAYER}'s Multi Battle Subway Results");
const u8 gText_SuperSingleBattleRoomResults[] = _("{PLAYER}'s Super Single Battle Subway Results");
const u8 gText_SuperDoubleBattleRoomResults[] = _("{PLAYER}'s Super Double Battle Subway Results");
const u8 gText_SuperMultiBattleRoomResults[]  = _("{PLAYER}'s Super Multi Battle Subway Results");
const u8 gText_LinkMultiBattleRoomResults[] = _("{PLAYER}'s Link Multi Battle Subway Results");
...
const u8 gText_HelloExclamation[] = _("Hello!");
const u8 gText_LetsGo[] = _("Let's go!");
const u8 gText_Regret[] = _("Regret!");
const u8 gText_NumberOne[] = _("NO. 1?");
...
const u8 gText_PokedexDiploma[] = _("{CLEAR 22}PLAYER: {CLEAR 16}{COLOR RED}{SHADOW LIGHT_RED}{PLAYER}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}\n\n"
                                    "This document certifies that\n"
                                    "you have made the great\n"
                                    "achievement of catching all\n"
                                    "the Pokémon in the Unova region.\n\n"
                                    "{CLEAR_TO 50}{COLOR RED}{SHADOW LIGHT_RED}GAME FREAK");
