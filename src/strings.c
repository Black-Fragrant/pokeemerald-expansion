...
const u8 gText_HealthboxNickname[] = _("{COLOR_HIGHLIGHT_SHADOW 3 0 1}");
const u8 gText_EmptySpace2[] = _(" "); // Unused
const u8 gText_HealthboxGender_Male[] = _("{COLOR_HIGHLIGHT_SHADOW 3 0 DYNAMIC_COLOR2}♂");
const u8 gText_HealthboxGender_Female[] = _("{COLOR_HIGHLIGHT_SHADOW 3 0 DYNAMIC_COLOR1}♀");
const u8 gText_HealthboxGender_None[] = _("{COLOR_HIGHLIGHT_SHADOW 3 0 DYNAMIC_COLOR2}");
