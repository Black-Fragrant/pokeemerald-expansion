...
static const u8 sDownArrowYCoords[] = { 0, 1, 2 };
    ...
    if (gTextFlags.autoScroll == 0)
    {
        ...
        else
        {
            ...
            BlitBitmapRectToWindow(
                ...
                16,
                ((gWindows[textPrinter->printerTemplate.windowId].window.width * 8) - 16),
                ((gWindows[textPrinter->printerTemplate.windowId].window.height * 8) - 12),
                16,
                16);
...
void DrawDownArrow(u8 windowId, u16 x, u16 y, u8 bgColor, bool32 drawArrow, u8 *counter, u8 *yCoordIndex)
{
    ...
    {
        FillWindowPixelRect(windowId, (bgColor << 4) | bgColor, x, y, 16, 16);
        if (drawArrow == 0)
        {
            switch (gTextFlags.useAlternateDownArrow)
            {
            ...
            BlitBitmapRectToWindow(windowId, arrowTiles, 0, sDownArrowYCoords[*yCoordIndex & 2], 8, 16, x, y - 2, 16, 16);
