...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_BoatRed = {
    .tileTag = TAG_NONE,
    ...
    .subspriteTables = gObjectEventSpriteOamTables_128x64,
    .anims = sAnimTable_Standard,
    .images = sPicTable_Boat,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_BoatBlue = {
    .tileTag = TAG_NONE,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_BoatYellow = {
    .tileTag = TAG_NONE,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_BoatRoyal = {
    .tileTag = TAG_NONE,
