...
const struct Tileset gTileset_Striaton =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Striaton,
...
const struct Tileset gTileset_IndoorStriaton =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_IndoorStriaton,
...
const struct Tileset gTileset_DreamYard =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_DreamYard,
    .palettes = gTilesetPalettes_DreamYard,
    .metatiles = gMetatiles_DreamYard,
...
const struct Tileset gTileset_IndoorRoute3 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_IndoorRoute3,
    .palettes = gTilesetPalettes_IndoorRoute3,
    .metatiles = gMetatiles_IndoorRoute3,
...
const struct Tileset gTileset_NacreneMuseum =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_NacreneMuseum,
    .palettes = gTilesetPalettes_NacreneMuseum,
    .metatiles = gMetatiles_NacreneMuseum,
    .metatileAttributes = gMetatileAttributes_NacreneMuseum,
    .callback = NULL,
};
...
const struct Tileset gTileset_CasteliaCity4 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CasteliaCity4,
    .palettes = gTilesetPalettes_CasteliaCity4,
    .metatiles = gMetatiles_CasteliaCity4,
    .metatileAttributes = gMetatileAttributes_CasteliaCity4,
    .callback = InitTilesetAnim_CasteliaCity4,
};

const struct Tileset gTileset_CasteliaCityCenter =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CasteliaCityCenter,
...
const struct Tileset gTileset_IndoorCastelia =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_IndoorCastelia,
...
const struct Tileset gTileset_IndoorPasserbyHQ =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_IndoorPasserbyHQ,
    .palettes = gTilesetPalettes_IndoorPasserbyHQ,
    .metatiles = gMetatiles_IndoorPasserbyHQ,
    .metatileAttributes = gMetatileAttributes_IndoorPasserbyHQ,
    .callback = NULL,
};

const struct Tileset gTileset_IndoorCasteliaStudio =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_IndoorCasteliaStudio,
    .palettes = gTilesetPalettes_IndoorCasteliaStudio,
    .metatiles = gMetatiles_IndoorCasteliaStudio,
    .metatileAttributes = gMetatileAttributes_IndoorCasteliaStudio,
    .callback = NULL,
};

const struct Tileset gTileset_CasteliaGym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CasteliaGym,
    .palettes = gTilesetPalettes_CasteliaGym,
    .metatiles = gMetatiles_CasteliaGym,
    .metatileAttributes = gMetatileAttributes_CasteliaGym,
    .callback = NULL,
};

const struct Tileset gTileset_CafeSonata =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CafeSonata,
    .palettes = gTilesetPalettes_CafeSonata,
    .metatiles = gMetatiles_CafeSonata,
...
const struct Tileset gTileset_IndoorLibertyGarden =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_IndoorLibertyGarden,
    .palettes = gTilesetPalettes_IndoorLibertyGarden,
    .metatiles = gMetatiles_IndoorLibertyGarden,
    .metatileAttributes = gMetatileAttributes_IndoorLibertyGarden,
    .callback = NULL,
};

const struct Tileset gTileset_IndoorRoute4 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_IndoorRoute4,
    .palettes = gTilesetPalettes_IndoorRoute4,
    .metatiles = gMetatiles_IndoorRoute4,
...
const struct Tileset gTileset_NimbasaPrimary =
{
    ...
    .callback = InitTilesetAnim_NimbasaPrimary,
};
...
const struct Tileset gTileset_NimbasaSecondary =
{
    ...
    .callback = InitTilesetAnim_NimbasaSecondary,
};
...
const struct Tileset gTileset_AnvilleTown =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_AnvilleTown,
    .palettes = gTilesetPalettes_AnvilleTown,
    .metatiles = gMetatiles_AnvilleTown,
    .metatileAttributes = gMetatileAttributes_AnvilleTown,
    .callback = NULL,
};

const struct Tileset gTileset_IndoorAnvilleTown =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_IndoorAnvilleTown,
    .palettes = gTilesetPalettes_IndoorAnvilleTown,
    .metatiles = gMetatiles_IndoorAnvilleTown,
