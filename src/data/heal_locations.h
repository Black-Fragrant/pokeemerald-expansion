static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_NUVEMA_TOWN - 1] = {MAP_GROUP(NUVEMA_TOWN), MAP_NUM(NUVEMA_TOWN), 14, 16},
    [HEAL_LOCATION_ACCUMULA_TOWN - 1] = {MAP_GROUP(ACCUMULA_TOWN), MAP_NUM(ACCUMULA_TOWN), 30, 21},
    [HEAL_LOCATION_STRIATON_CITY_1 - 1] = {MAP_GROUP(STRIATON_CITY), MAP_NUM(STRIATON_CITY), 10, 10},
    [HEAL_LOCATION_STRIATON_CITY_2 - 1] = {MAP_GROUP(STRIATON_CITY), MAP_NUM(STRIATON_CITY), 10, 10},
};
