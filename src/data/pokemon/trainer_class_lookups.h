const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_TEAM_PLASMA_GRUNT_F] = TRAINER_PIC_HIKER,
    [FACILITY_CLASS_TEAM_PLASMA_GRUNT_M] = TRAINER_PIC_HIKER,
    [FACILITY_CLASS_TEAM_PLASMA_BOSS_1] = TRAINER_PIC_HIKER,
    [FACILITY_CLASS_TEAM_PLASMA_BOSS_2] = TRAINER_PIC_HIKER,
    [FACILITY_CLASS_SCIENTIST] = TRAINER_PIC_HIKER,
    // end fireBlack
};
