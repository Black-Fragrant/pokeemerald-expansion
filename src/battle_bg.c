...
{
    LoadUserWindowBorderGfx(2, 80, BG_PLTT_ID(7));
...
void LoadBattleTextboxAndBackground(void)
{
    ...
    {
        LoadPalette(gBattleTextboxPalette,                  BG_PLTT_ID(12 + i),      PLTT_SIZE_4BPP);
