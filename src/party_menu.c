...
static void CB2_ShowPokemonSummaryScreen(void)
{
    if (gPartyMenu.menuType == PARTY_MENU_TYPE_IN_BATTLE)
    {
        ...
        */
        ...
        ShowPokemonSummaryScreen_BW(SUMMARY_MODE_LOCK_MOVES, party, gPartyMenu.slotId, count, CB2_ReturnToPartyMenuFromSummaryScreen);
        // end bwSummaryScreen
    }
    else if (gPartyMenu.menuType == PARTY_MENU_TYPE_CHOOSE_HALF)
    {
        ...
        ShowPokemonSummaryScreen_BW(SUMMARY_MODE_LOCK_MOVES, gParties[B_TRAINER_0], gPartyMenu.slotId, gPartiesCount[B_TRAINER_0] - 1, CB2_ReturnToPartyMenuFromSummaryScreen);
        // end bwSummaryScreen
    }
    else
    {
...
static void CB2_ShowSummaryScreenToForgetMove(void)
{
    ShowSelectMovePokemonSummaryScreen_BW(gParties[B_TRAINER_0], gPartyMenu.slotId, 1, CB2_ReturnToPartyMenuWhileLearningMove, gPartyMenu.data1);
}
...
{
    ShowPokemonSummaryScreen_BW(SUMMARY_MODE_SELECT_MOVE, gParties[B_TRAINER_0], gSpecialVar_0x8004, 1, CB2_ReturnToField);
