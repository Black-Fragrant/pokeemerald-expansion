...
static const enum Item sPrizeListSkillSwap[]   = {ITEM_TM_HIDDEN_POWER,  ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const enum Item sPrizeListGigaDrain[]   = {ITEM_TM_HIDDEN_POWER,  ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
