...
const u16 gIntroPublisher_Pal[] = INCGFX_U16("graphics/intro/publisher.png", ".gbapal");
const u32 gIntroPublisher_Gfx[] = INCGFX_U32("graphics/intro/publisher.png", ".4bpp.smol");
const u32 gIntroPublisher_Tilemap[] = INCGFX_U32("graphics/intro/publisher.bin", ".smolTM");
