...
const u16 gTransparentWindow_Pal[] = INCBIN_U16("graphics/text_window/transparent.gbapal");
...
const u8 gShoutWindow_Gfx[] = INCBIN_U8("graphics/text_window/shout.4bpp");
const u8 gTransparentWindow_Gfx[] = INCBIN_U8("graphics/text_window/transparent.4bpp");
