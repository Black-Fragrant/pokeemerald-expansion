...
const u16 gNamingScreenBwBg_Pal[]                 = INCGFX_U16("graphics/naming_screen_bw/bg.pal", ".gbapal");
const u16 gNamingScreenBwText_Pal[]               = INCGFX_U16("graphics/naming_screen_bw/text.pal", ".gbapal");
const u16 gNamingScreenBwSelectedButton_Pal[]     = INCGFX_U16("graphics/naming_screen_bw/button_selected.pal", ".gbapal");
const u16 gNamingScreenBwCursor_Pal[]             = INCGFX_U16("graphics/naming_screen_bw/cursor.pal", ".gbapal");
const u16 gNamingScreenBwUnderscore_Pal[]         = INCGFX_U16("graphics/naming_screen_bw/underscore.pal", ".gbapal");
const u16 gNamingScreenBwPcIcon_Pal[]             = INCGFX_U16("graphics/naming_screen_bw/pc_icon/0.png", ".gbapal");
const u16 gNamingScreenBwRival_Pal[]              = INCGFX_U16("graphics/naming_screen_bw/rival.png", ".gbapal");
const u32 gNamingScreenBwTiles_Gfx[]              = INCGFX_U32("graphics/naming_screen_bw/tiles.png", ".4bpp.smol");
const u32 gNamingScreenBwCursor_Gfx[]             = INCGFX_U32("graphics/naming_screen_bw/cursor.png", ".4bpp");
const u32 gNamingScreenBwActiveCursorSmall_Gfx[]  = INCGFX_U32("graphics/naming_screen_bw/active_cursor_small.png", ".4bpp");
const u32 gNamingScreenBwActiveCursorBig_Gfx[]    = INCGFX_U32("graphics/naming_screen_bw/active_cursor_big.png", ".4bpp");
const u32 gNamingScreenBwUnderscore_Gfx[]         = INCGFX_U32("graphics/naming_screen_bw/underscore.png", ".4bpp");
const u32 gNamingScreenBwPcIcon0_Gfx[]            = INCGFX_U32("graphics/naming_screen_bw/pc_icon/0.png", ".4bpp");
const u32 gNamingScreenBwPcIcon1_Gfx[]            = INCGFX_U32("graphics/naming_screen_bw/pc_icon/1.png", ".4bpp");
const u32 gNamingScreenBwRival_Gfx[]              = INCGFX_U32("graphics/naming_screen_bw/rival.png", ".4bpp");
const u32 gNamingScreenBwBackground_Tilemap[]     = INCGFX_U32("graphics/naming_screen_bw/bg.bin", ".smolTM");
const u32 gNamingScreenBwButtons_Tilemap[]        = INCGFX_U32("graphics/naming_screen_bw/buttons_eng.bin", ".smolTM");
const u32 gNamingScreenBwKeyboardUpper_Tilemap[]  = INCGFX_U32("graphics/naming_screen_bw/letters_uppers.bin", ".smolTM");
const u32 gNamingScreenBwKeyboardLower_Tilemap[]  = INCGFX_U32("graphics/naming_screen_bw/letters_lowers.bin", ".smolTM");
const u32 gNamingScreenBwKeyboardSymbols_Tilemap[] = INCGFX_U32("graphics/naming_screen_bw/symbols.bin", ".smolTM");
...
const u16 gTransparentWindow_Pal[] = INCGFX_U16("graphics/text_window/transparent.pal", ".gbapal");
...
const u16 gTitleScreenBgPalettes[]         = INCBIN_U16("graphics/title_screen/pokemon_logo.gbapal",
                                                        "graphics/title_screen/reshiram.gbapal");
...
const u32 gLargeItemPic_XtransceiverBlue[]   = INCGFX_U32("graphics/large_item/xtransceiver_blue.png", ".4bpp.smol");
const u32 gLargeItemPic_XtransceiverRed[]    = INCGFX_U32("graphics/large_item/xtransceiver_red.png", ".4bpp.smol");
const u32 gLargeItemPic_TownMap[]            = INCGFX_U32("graphics/large_item/town_map.png", ".4bpp.smol");
const u32 gLargeItemPic_PalPad[]             = INCGFX_U32("graphics/large_item/pal_pad.png", ".4bpp.smol");
const u32 gLargeItemPic_DowsingMachine[]     = INCGFX_U32("graphics/large_item/dowsing_machine.png", ".4bpp.smol");
const u32 gLargeItemPic_DragonSkull[]        = INCGFX_U32("graphics/large_item/dragon_skull.png", ".4bpp.smol");
const u32 gLargeItemPic_LibertyPass[]        = INCGFX_U32("graphics/large_item/liberty_pass.png", ".4bpp.smol");
const u32 gLargeItemPic_Bicycle[]            = INCGFX_U32("graphics/large_item/bicycle.png", ".4bpp.smol");
const u32 gLargeItemPic_VsRecorder[]         = INCGFX_U32("graphics/large_item/vs_recorder.png", ".4bpp.smol");
const u32 gLargeItemPic_PropCase[]           = INCGFX_U32("graphics/large_item/prop_case.png", ".4bpp.smol");
const u32 gLargeItemPic_LightStone[]         = INCGFX_U32("graphics/large_item/light_stone.png", ".4bpp.smol");
const u32 gLargeItemPic_DarkStone[]          = INCGFX_U32("graphics/large_item/dark_stone.png", ".4bpp.smol");
const u32 gLargeItemPic_SuperRod[]           = INCGFX_U32("graphics/large_item/super_rod.png", ".4bpp.smol");
const u32 gLargeItemPic_Gram[]               = INCGFX_U32("graphics/large_item/gram.png", ".4bpp.smol");
const u32 gLargeItemPic_Gracidea[]           = INCGFX_U32("graphics/large_item/gracidea.png", ".4bpp.smol");
const u32 gLargeItemPic_PokedexM[]           = INCGFX_U32("graphics/large_item/pokedex_m.png", ".4bpp.smol");
const u32 gLargeItemPic_PokedexF[]           = INCGFX_U32("graphics/large_item/pokedex_f.png", ".4bpp.smol");

const u16 gLargeItemPicPalette_XtransceiverBlue[]   = INCGFX_U16("graphics/large_item/xtransceiver_blue.pal", ".gbapal");
const u16 gLargeItemPicPalette_XtransceiverRed[]    = INCGFX_U16("graphics/large_item/xtransceiver_red.pal", ".gbapal");
const u16 gLargeItemPicPalette_TownMap[]            = INCGFX_U16("graphics/large_item/town_map.pal", ".gbapal");
const u16 gLargeItemPicPalette_PalPad[]             = INCGFX_U16("graphics/large_item/pal_pad.pal", ".gbapal");
const u16 gLargeItemPicPalette_DowsingMachine[]     = INCGFX_U16("graphics/large_item/dowsing_machine.pal", ".gbapal");
const u16 gLargeItemPicPalette_DragonSkull[]        = INCGFX_U16("graphics/large_item/dragon_skull.pal", ".gbapal");
const u16 gLargeItemPicPalette_LibertyPass[]        = INCGFX_U16("graphics/large_item/liberty_pass.pal", ".gbapal");
const u16 gLargeItemPicPalette_Bicycle[]            = INCGFX_U16("graphics/large_item/bicycle.pal", ".gbapal");
const u16 gLargeItemPicPalette_VsRecorder[]         = INCGFX_U16("graphics/large_item/vs_recorder.pal", ".gbapal");
const u16 gLargeItemPicPalette_PropCase[]           = INCGFX_U16("graphics/large_item/prop_case.pal", ".gbapal");
const u16 gLargeItemPicPalette_LightStone[]         = INCGFX_U16("graphics/large_item/light_stone.pal", ".gbapal");
const u16 gLargeItemPicPalette_DarkStone[]          = INCGFX_U16("graphics/large_item/dark_stone.pal", ".gbapal");
const u16 gLargeItemPicPalette_SuperRod[]           = INCGFX_U16("graphics/large_item/super_rod.pal", ".gbapal");
const u16 gLargeItemPicPalette_Gram[]               = INCGFX_U16("graphics/large_item/gram.pal", ".gbapal");
const u16 gLargeItemPicPalette_Gracidea[]           = INCGFX_U16("graphics/large_item/gracidea.pal", ".gbapal");
